...
class Netresearch_Epayments_Model_Config implements Netresearch_Epayments_Model_ConfigInterface
{
    ...
    {
        return Mage::getConfig()->getNode('modules/Netresearch_Epayments/version');
    }
