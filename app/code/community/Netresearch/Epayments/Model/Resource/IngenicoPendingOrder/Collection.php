...
class Netresearch_Epayments_Model_Resource_IngenicoPendingOrder_Collection
    extends Mage_Sales_Model_Resource_Order_Collection
{
    ...
    {
        $this->buildFilter($scopeId);
        $this->addFieldToFilter("order_update_wr_status", Netresearch_Epayments_Model_OrderUpdate_Order::STATUS_WAIT);
