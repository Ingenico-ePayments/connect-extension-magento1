...
$table = $installer->getConnection()
    ...
    ->addIndex(
        $installer->getIdxName('netresearch_epayments/token', array('customer_id')),
        array('customer_id')
    )
    ->addForeignKey(
        $installer->getFkName('netresearch_epayments/token', 'customer_id', 'customer/entity', 'entity_id'),
