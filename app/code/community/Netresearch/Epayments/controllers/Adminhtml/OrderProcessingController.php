...
class Netresearch_Epayments_Adminhtml_OrderProcessingController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function refreshOrderStatusAction()
    {
        ...
        try {
            ...
            /** @var Netresearch_Epayments_Model_Ingenico_RetrievePayment $status */
            $status = Mage::getModel('netresearch_epayments/ingenico_retrievePayment');
