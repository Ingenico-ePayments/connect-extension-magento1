...
class Ingenico_Connect_Adminhtml_RefundProcessingController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function approveCreditMemoAction()
    {
        ...
        /** @var Ingenico_Connect_Model_Ingenico_ApproveRefund $approveRefund */
        $approveRefund = Mage::getSingleton('ingenico_connect/ingenico_approveRefund');
        try {
