 ...
 */
class Ingenico_Connect_Model_WxTransfer_Client implements Ingenico_Connect_Model_WxTransfer_ClientInterface
{
    /**
    ...
    /**
     * @var \Ingenico_Connect_Model_WxTransfer_Sftp_ClientInterface
     */
    private $sftpClient;
    ...
    {
        $this->epaymentConfig = Mage::getModel('ingenico_connect/config');
        $this->sftpClient = Mage::getModel('ingenico_connect/wxTransfer_sftp_client');
