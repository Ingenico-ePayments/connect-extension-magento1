...
use Ingenico_Connect_Model_WxTransfer_Sftp_ClientInterface as ClientInterface;

/**
 * Class Client
 * @package Ingenico\Connect\WxTransfer\Sftp
 */
class Ingenico_Connect_Model_WxTransfer_Sftp_Client implements ClientInterface
{
    /** @var \Varien_Io_Sftp */
