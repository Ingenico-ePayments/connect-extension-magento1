...
class Ingenico_Connect_Model_OrderUpdate_Order
{
    ...
    /** @var Ingenico_Connect_Model_OrderUpdate_Scheduler $scheduler */
    private $scheduler;
    ...
    public function __construct()
    {
        ...
        $this->scheduler = Mage::getModel('ingenico_connect/orderUpdate_scheduler');
        $this->retrievePaymentModel = Mage::getModel('ingenico_connect/ingenico_retrievePayment');
    }
