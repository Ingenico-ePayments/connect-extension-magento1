 ...
 *
 *
 * Class Ingenico_Connect_Model_Adminhtml_System_Config_Backend_Validator_ApiEndpoint
 */
class Ingenico_Connect_Model_Adminhtml_System_Config_Backend_Validator_ApiEndpoint
    extends Mage_Core_Model_Config_Data
{
    ...
    /** @var Ingenico_Connect_Model_Ingenico_TestAccount */
    protected $testAccountAction;

    /** @var Mage_Adminhtml_Model_Session */
    protected $adminSession;

    /** @var  Ingenico_Connect_Model_Config $epaymentsConfig */
    ...
    protected function _construct()
    {
        ...
        $this->testAccountAction = Mage::getSingleton('ingenico_connect/ingenico_testAccount');
    ...
    {
        $epaymentsConfig = Mage::getModel('ingenico_connect/config');
    ...
    public function runTest($data = array())
    {
        ...
        if ($testResponse === Ingenico_Connect_Model_Ingenico_TestAccount::STATUS_OK) {
