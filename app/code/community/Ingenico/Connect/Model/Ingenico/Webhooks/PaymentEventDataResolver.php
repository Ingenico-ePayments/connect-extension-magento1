...
/**
 * Class Ingenico_Connect_Model_Ingenico_Webhooks_PaymentEventDataResolver
 */
class Ingenico_Connect_Model_Ingenico_Webhooks_PaymentEventDataResolver implements EventDataResolverInterface
{
    /**
