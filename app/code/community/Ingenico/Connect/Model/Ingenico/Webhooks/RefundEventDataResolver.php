...
/**
 * Class Ingenico_Connect_Model_Ingenico_Webhooks_RefundEventDataResolver
 */
class Ingenico_Connect_Model_Ingenico_Webhooks_RefundEventDataResolver implements EventDataResolverInterface
{
    /**
