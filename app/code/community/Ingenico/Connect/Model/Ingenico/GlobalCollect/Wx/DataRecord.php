...
use Ingenico_Connect_Model_Ingenico_GlobalCollect_Wx_PaymentData as PaymentData;

class Ingenico_Connect_Model_Ingenico_GlobalCollect_Wx_DataRecord
{
    private $MerchantID;
    private $OrderID;
    private $EffortID;
     ...
     * @return Ingenico_Connect_Model_Ingenico_GlobalCollect_Wx_DataRecord
     */
